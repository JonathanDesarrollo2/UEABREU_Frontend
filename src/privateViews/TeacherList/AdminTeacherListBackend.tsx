...
import { FaList, FaChalkboardTeacher } from 'react-icons/fa';
import { FaDeleteLeft } from "react-icons/fa6";
import AnimatedPage from '../../components/AnimatedPage';
import { sanitizeText } from '../../library/sanitizeInput';
import LoadListTeachersAPI from './components/LoadListTeacherAPI';
...
export default function AdminListTeachersBackend() {
      ...
      <div className="flex flex-col min-h-screen p-4 lg:p-8">
        ...
        <div className="flex flex-col lg:flex-row gap-4 w-full mb-6">
          ...
          <div className="flex gap-2 w-full lg:w-auto">
            ...
            >
              <FaChalkboardTeacher className="mr-2 inline-block" />
              Nuevo
            </button>
        ...
        <div className="flex-1">
          <LoadListTeachersAPI Buscar={buscar} />
        </div>
      </div>
    </AnimatedPage>
  );
